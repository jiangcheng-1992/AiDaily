...
export const interestingWorks: WorkItem[] = [
  ...
  },
  {
    ...
    externalUrl: "/interesting/playground/tiny-ai-game-lab",
    githubUrl: "https://github.com/",
  ...
  {
    id: "ai-snake-training-lab",
    title: "AI 贪吃蛇训练实验室",
    description: "观察神经网络如何从随机移动开始学习吃豆和避墙，适合用小游戏理解强化学习。",
    whyInteresting: "它把抽象的训练过程变成可视化玩法，用户能直观看到策略如何一轮轮变好。",
    type: "app",
    source: "manual",
    coverUrl: imageUrl("browser game interface showing an AI snake learning pathfinding, neon grid, training chart, playful educational UI", "landscape_16_9"),
    externalUrl: "/interesting/playground/ai-snake-training-lab",
    authorName: "AI Game Lab",
    toolNames: ["TensorFlow", "Canvas", "Reinforcement Learning"],
    tags: ["AI小游戏", "H5游戏", "强化学习", "浏览器可玩"],
    status: "approved",
    featured: true,
    sourceVerified: true,
    viewCount: 4380,
  ...
  {
    id: "prompt-adventure-game-builder",
    title: "Prompt 文字冒险生成器",
    description: "输入世界观和角色，生成分支剧情、选项和结局，适合快速做 AI 文字冒险原型。",
    whyInteresting: "它不依赖复杂素材，能用最轻的方式验证互动叙事和角色设定是否好玩。",
    type: "app",
    source: "manual",
    coverUrl: imageUrl("AI text adventure game builder, branching story map, fantasy terminal UI, character cards, cozy dark interface", "landscape_16_9"),
    externalUrl: "/interesting/playground/prompt-adventure-game-builder",
    authorName: "Story Game Studio",
    toolNames: ["Twine", "GPT", "HTML5"],
    tags: ["AI小游戏", "互动叙事", "H5游戏", "浏览器可玩"],
    status: "approved",
    featured: false,
    sourceVerified: true,
    viewCount: 3920,
  ...
  {
    id: "ai-prompt-battle-arena",
    title: "AI Prompt 对战小剧场",
    description: "两段 Prompt 控制角色行动，系统根据约束生成回合结果，适合测试提示词策略。",
    whyInteresting: "它把 Prompt 写作变成对战玩法，能让用户在输赢反馈里理解约束、目标和角色设定。",
    type: "app",
    source: "manual",
    coverUrl: imageUrl("AI prompt battle arena browser game, two robot characters, command cards, turn based combat UI, vibrant game art", "landscape_16_9"),
    externalUrl: "/interesting/playground/ai-prompt-battle-arena",
    authorName: "Prompt Arena",
    toolNames: ["GPT", "Gemini", "HTML5"],
    tags: ["AI小游戏", "Prompt", "回合制", "浏览器可玩"],
    status: "approved",
    featured: false,
    sourceVerified: true,
    viewCount: 3680,
  ...
  {
    id: "ai-dungeon-master-demo",
    title: "AI 地牢主持人 Demo",
    description: "用 AI 扮演地牢主持人，根据玩家选择实时生成事件、道具和分支剧情。",
    whyInteresting: "它展示了 LLM 在游戏里的核心价值：不是替代画面，而是让剧情和反馈更自由。",
    type: "app",
    source: "manual",
    coverUrl: imageUrl("AI dungeon master web game, fantasy map, chat choices, dice, glowing cards, cinematic tabletop RPG interface", "landscape_16_9"),
    externalUrl: "/interesting/playground/ai-dungeon-master-demo",
    authorName: "Dungeon AI",
    toolNames: ["LLM", "RPG", "Web App"],
    tags: ["AI小游戏", "角色扮演", "互动叙事", "浏览器可玩"],
    status: "approved",
    featured: false,
    sourceVerified: true,
    viewCount: 4260,
    ...
    clickCount: 640,
    heatScore: 89,
    createdAt: "2026-05-24T17:25:00.000Z",
    categoryHint: "game",
  },
  {
    id: "ai-drawing-guess-game",
    title: "AI 你画我猜挑战",
    description: "玩家画草图或输入线索，AI 猜答案并给出相似度反馈，适合轻量互动和社交传播。",
    whyInteresting: "玩法门槛低、反馈即时，能把图像识别和生成能力包装成用户愿意分享的小游戏。",
    type: "app",
    source: "manual",
    coverUrl: imageUrl("AI drawing guessing browser game, doodle canvas, robot guessing answer, colorful playful interface", "landscape_16_9"),
    externalUrl: "/interesting/playground/ai-drawing-guess-game",
    authorName: "Sketch AI",
    toolNames: ["Image Recognition", "Canvas", "ML"],
    tags: ["AI小游戏", "你画我猜", "H5游戏", "浏览器可玩"],
    status: "approved",
    featured: false,
    sourceVerified: true,
    viewCount: 4010,
